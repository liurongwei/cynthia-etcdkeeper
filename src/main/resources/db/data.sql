...
insert into server_config (id ,name, title, endpoints, api_version, use_tls, key_file, ca_file, cert_file, secure, use_auth, username, `password`)
values (4, 'v3-tls-secure','192.168.87.10','192.168.87.10:2379', '3', true ,'D:/linux/k8s/node0/tls/etcd-key.pem' ,
           'D:/linux/k8s/node0/tls/ca.pem' ,'D:/linux/k8s/node0/tls/etcd.pem' , true ,false ,null ,null )
...
insert into server_config (id ,name, title, endpoints, api_version, use_tls, key_file, ca_file, cert_file, secure, use_auth, username, `password`)
values (6, 'v3-tls-home','192.168.31.127','192.168.31.127:2379', '3', false ,'D:/linux/k8s/node0/tls/etcd-key.pem' ,
        'D:/linux/k8s/node0/tls/ca.pem' ,'D:/linux/k8s/node0/tls/etcd.pem', true , false ,null ,null )
    on duplicate key update `name`='v3-tls-home';

insert into server_config (id ,name, title, endpoints, api_version, use_tls, key_file, ca_file, cert_file, secure, use_auth, username, `password`)
values (7, 'v3-tls-insecure','192.168.87.10','192.168.87.10:2379', '3', true ,'D:/linux/k8s/node0/tls/etcd-key.pem' ,
