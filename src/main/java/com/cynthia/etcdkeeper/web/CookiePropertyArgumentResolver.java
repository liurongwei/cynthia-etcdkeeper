package com.cynthia.etcdkeeper.web;
...
public class CookiePropertyArgumentResolver implements HandlerMethodArgumentResolver {
    ...
    public Object resolveArgument(MethodParameter methodParameter, ModelAndViewContainer modelAndViewContainer,
        ...
        for (Field field : fields) {
            initFields(field, cookies, parameter);
        }

        return parameter;
    }

    private void initFields(Field field, Map<String, String> cookies, Object parameter) throws IllegalAccessException {
